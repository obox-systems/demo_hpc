...
fn bench_add_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("add_vectors_opencl_one", |b| {
        b.iter(|| add_vectors_with_opencl(&first, &second, 1))
    });
}
...
fn batch1000_add_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("batch1000_add_vectors_opencl", |b| {
        b.iter(|| add_vectors_with_opencl(&first, &second, 1000))
    });
}
...
fn batch1000000_add_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("batch1000000_add_vectors_opencl", |b| {
        b.iter(|| add_vectors_with_opencl(&first, &second, 1000000))
    });
}
...
fn dry_run_add_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("dry_run_add_vectors_opencl", |b| {
        b.iter(|| add_vectors_with_opencl(&first, &second, 1))
    });
}
...
fn bench_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("sum_vectors_opencl_one", |b| {
        b.iter(|| sum_array_opencl(&first, 1))
    });
}
...
fn batch1000_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("batch1000_sum_vectors_opencl", |b| {
        b.iter(|| sum_array_opencl(&first, 1000))
    });
}
...
fn batch1000000_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("batch1000000_sum_vectors_opencl", |b| {
        b.iter(|| sum_array_opencl(&first, 100000))
    });
}
...
fn dry_run_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("dry_run_sum_vectors_opencl", |b| {
        b.iter(|| sum_array_opencl(&first, 1))
    });
}
...
fn bench_optimized_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("optimized_sum_vectors_opencl_one", |b| {
        b.iter(|| optimized_array_opencl(&first, 1))
    });
}
...
fn batch1000_optimized_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("batch1000_optimized_sum_vectors_opencl", |b| {
        b.iter(|| optimized_array_opencl(&array1, 1000))
    });
}
...
fn batch1000000_optimized_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("batch1000000_optimized_sum_vectors_opencl", |b| {
        b.iter(|| optimized_array_opencl(&array1, 100000))
    });
}
...
fn dry_run_optimized_sum_vectors_with_opencl(c: &mut Criterion) {
    ...
    c.bench_function("dry_run_optimized_sum_vectors_opencl", |b| {
        b.iter(|| optimized_array_opencl(&array1, 1))
    });
}
