...
fn batch1000_add_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("batch1000_add_arrays_rayon", |b| b.iter(|| add_arrays_rayon_batch(&first, &second, 1000)));
}
...
fn batch1000000_add_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("batch1000000_add_arrays_rayon", |b| b.iter(|| add_arrays_rayon_batch(&first, &second, 1000000)));
}
...
fn dry_run_add_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("dry_run_add_arrays_rayon", |b| b.iter(|| add_arrays_rayon_batch(&first, &second, 1)));
}
...
fn bench_sum_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("sum_arrays_rayon_one", |b| b.iter(|| sum_array_rayon(&first)));
}
...
fn batch1000_sum_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("batch1000_sum_arrays_rayon", |b| b.iter(|| sum_array_rayon_batch(&first, 1000)));
}
...
fn batch1000000_sum_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("batch1000000_sum_arrays_rayon", |b| b.iter(|| sum_array_rayon_batch(&first, 1000000)));
}

fn dry_run_sum_arrays_rayon(c: &mut Criterion) {
  let first = vec![0.0];

  c.bench_function("dry_run_sum_arrays_rayon", |b| b.iter(|| sum_array_rayon_batch(&first, 1)));
}
...
fn bench_optimized_sum_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("optimized_sum_arrays_rayon_one", |b| b.iter(|| optimized_array_rayon(&first, 0, first.len() - 1)));
}
...
fn batch1000_optimized_sum_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("batch1000_optimized_sum_arrays_rayon", |b| b.iter(|| optimized_sum_array_rayon_batch(&first, 0, first.len() - 1, 1000)));
}
...
fn batch1000000_optimized_sum_arrays_rayon(c: &mut Criterion) {
  ...
  c.bench_function("batch1000000_optimized_sum_arrays_rayon", |b| b.iter(|| optimized_sum_array_rayon_batch(&first, 0, first.len() - 1, 1000000)));
}

fn dry_run_optimized_sum_arrays_rayon(c: &mut Criterion) {
  let first = vec![0.0];

  c.bench_function("dry_run_optimized_sum_arrays_rayon", |b| b.iter(|| optimized_sum_array_rayon_batch(&first, 0, first.len() - 1, 1)));
}
