...
fn bench_add_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("add_arrays_tch_one", |b| {
        b.iter(|| add_arrays_tch(&first1, &second1))
    });
}
...
fn batch1000_add_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("batch1000_add_arrays_tch", |b| {
        b.iter(|| batch_add_arrays_tch(&first1, &second1, 1000))
    });
}
...
fn batch1000000_add_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("batch1000000_add_arrays_tch", |b| {
        b.iter(|| batch_add_arrays_tch(&first1, &second1, 1000000))
    });
}
...
fn dry_run_add_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("dry_run_add_arrays_tch", |b| {
        b.iter(|| batch_add_arrays_tch(&first1, &second1, 1))
    });
}
...
fn batch1000_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("batch1000_sum_arrays_tch", |b| {
        b.iter(|| batch_sum_array_tch(&first1, 1000))
    });
}
...
fn batch1000000_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("batch1000000_sum_arrays_tch", |b| {
        b.iter(|| batch_sum_array_tch(&first1, 1000000))
    });
}
...
fn dry_run_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("dry_run_sum_arrays_tch", |b| {
        b.iter(|| batch_sum_array_tch(&first1, 1))
    });
}
...
fn bench_optimized_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("optimized_sum_arrays_tch_one", |b| {
        b.iter(|| optimized_array_tch(&first1, 0, (first1.size1().unwrap() - 1) as usize))
    });
}
...
fn batch1000_optimized_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("batch1000_optimized_sum_arrays_tch", |b| {
        b.iter(|| {
            batch_optimized_sum_array_tch(&first1, 0, (first1.size1().unwrap() - 1) as usize, 1000)
        })
    });
}
...
fn batch1000000_optimized_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("batch1000000_optimized_sum_arrays_tch", |b| {
        b.iter(|| {
            batch_optimized_sum_array_tch(&first1, 0, (first1.size1().unwrap() - 1) as usize, 10000)
        })
    });
}
...
fn dry_run_optimized_sum_arrays_tch(c: &mut Criterion) {
    ...
    c.bench_function("dry_run_optimized_sum_arrays_tch", |b| {
        b.iter(|| {
            batch_optimized_sum_array_tch(&first1, 0, (first1.size1().unwrap() - 1) as usize, 1)
        })
    });
}
